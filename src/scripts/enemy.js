...
export default class Enemy {
    ...
    draw() {
        if (!this.exploding) {
            ...
            this.ctx.drawImage(this.explosion, this.explodingFrames[this.exf], 136, 32, 48, ( this.dx * this.canvas.width), ((this.shipPos[1] / 222) * this.canvas.height), (this.dz * (this.canvas.width * (40 / 256))), (this.dz * (this.canvas.height * (40 / 222))));
        }
    };
